 ...
 * @author ehaya
 */
public class ViewflightAdmin extends javax.swing.JFrame {

    /**l
     * Creates new form ViewflightAdmin
     */
    public ViewflightAdmin() {
        initComponents();
        viewflight();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FlightNO", "From_Airport", "To_airport", "AircraftID", "Departure-Time", "Arrival_time"
            }
        ));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        AddFight  Addfight  = new AddFight ();
        Addfight.setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    public void viewflight()
    {
            ...
            while(resultset.next())
            {
                ...
                String data[]={flightno,from,to,aircraft,Departure_Time,Arrival_Time};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewflightAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewflightAdmin().setVisible(true);
            }
        });
    }
