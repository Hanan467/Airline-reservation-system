...
public class AddAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String role = "Admin";
        boolean register=JDBC.register_user(id,firstname,lastname,Email,phone_no,password,role);
        if (register)
        JOptionPane.showMessageDialog(this, "You have succesfully Addeed an Admin",
